...
#ifndef __DORAMI_MAIN_H__
#define __DORAMI_MAIN_H__
...
/** Index of mscratch member in sbi_trap_regs */
#define SBI_TRAP_REGS_mscratch			35
/** Index of sscratch member in sbi_trap_regs */
#define SBI_TRAP_REGS_sscratch			36
...
struct sbi_trap_regs {
	...
	/** mscratch register state (only for OSBI/secondary) */
	unsigned long mscratch;
	/** sscratch register state (only for OSBI/secondary) */
...
//Target variable describes if enclave(1) or not(0)
