...
int sbi_ecall_keystone_enclave_handler(unsigned long extid, unsigned long funcid,
                     ...
                     struct sbi_trap_info *out_trap)
{
  ...
  // sbi_printf("ENTERING ENCLAVE HANDLER; FUNC: %lx\n", funcid);
  ...
  //sbi_printf("EXITING ENCLAVE HANDLER; FUNC: %lx\n", funcid);
