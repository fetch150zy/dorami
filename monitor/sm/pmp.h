...
#define PMP_MAX_N_REGION  8 //maximum number of PMP regions
...
#define EPMP_ALL_ALL_PERM (PMP_L | PMP_W | PMP_X | PMP_R)

#define EPMP_ALL_RW (PMP_W | PMP_R) //depending on wether the execution has epmp or not
#define EPMP_M_RX ( PMP_X | PMP_R)
#define EPMP_M_RW (PMP_W | PMP_R)
#define EPMP_SU_RWX (PMP_W | PMP_X | PMP_R)
