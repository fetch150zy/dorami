...
#define csr_set_imm(csr, val)                                          \
	({                                                         \
		__asm__ __volatile__("csrsi " __ASM_STR(csr) ", " __ASM_STR(val) \
				     :                             \
				     : 			                   \
				     : "memory");                  \
	})

#define csr_clear_imm(csr, val)                                          \
	({                                                         \
		__asm__ __volatile__("csrci " __ASM_STR(csr) ", " __ASM_STR(val) \
				     :                             \
				     : 			                   \
				     : "memory");                  \
	})
