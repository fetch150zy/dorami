...
sbi_printf("[OSBI] HART %d now preparing to jump to 0x%lx, Mode: %d, virt %d, arg0: 0x%lx, arg1: 0x%lx\n", arg0, next_addr, next_mode, next_virt, arg0, arg1);
	...
	asm("j mon_test_pmplastbit_justbefore"  : : "r"(a0), "r"(a1)); //to the jumper...
	__builtin_unreachable();
}
